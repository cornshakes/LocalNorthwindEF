...
using LocalNorthwindEF.Views;
using Microsoft.EntityFrameworkCore;

namespace LocalNorthwindEF;

public partial class NorthwindContextWithViews : DbContext
{
    public NorthwindContextWithViews()
    {
    }

    public NorthwindContextWithViews(DbContextOptions<NorthwindContextWithViews> options)
        : base(options)
    {
    }
